...
#    joints.append(Pw[18][0])
    ...
    if this.gender == 'female':#female model 14 markers
    ...
    else: #male model 14 markers
    	joints.append(v[5106])
   	joints.append(v[6137])
    	joints.append(v[5804])
    	joints.append(v[106])
    	joints.append(v[2854])
    	joints.append(v[5365])
    	joints.append(v[321])
    	joints.append(v[3188])
    	joints.append(v[2387])
    	joints.append(v[5610])
    	joints.append(v[6438])
    	joints.append(v[2604])
    	joints.append(v[4712])
    	joints.append(v[8055])
    	joints.append(v[3306])
    	joints.append(v[1635])
    #print joints
    skeleton = []
    skeleton.append([0,2])
